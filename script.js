...
const catalogoTecnicas = publicaciones.map(p => ({ ...p, categoria: 'tecnicas' }));
const catalogoCientificas = (window.catalogoPublicaciones?.cientificas || []).map(p => ({ ...p, categoria: 'cientificas' }));
const catalogo = {
  todos: [...catalogoTecnicas, ...catalogoCientificas],
